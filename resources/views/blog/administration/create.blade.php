@extends('layouts.app')
@section('title', 'Crear Post | Glory Store')
...
<div class="container-index-user conrtainer-table-d">
    ...
    <div class="container-forr">
        <form action="{{ route('blog.administration.store') }}" method="post" class="con-sect-a-p" enctype="multipart/form-data">
            @csrf
            ...
            <section class="foo-add-u con__two__sub__form">
                ...
                <a href="{{ route('blog.administration')}}">Volver</a>
            </section>
        </form>
    </div>
</div>
