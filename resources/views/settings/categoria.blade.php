...
<div class="con__settings conrtainer-table-d">
    ...
    <div class="body__settigs">
        ...
        <div class="con_info">
            <form action="{{ route('category.store') }}" method="post" class="form__one__col" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="file" id="pictures_category" name="photo" accept="image/png,image/jpeg">
                </div>
        ...
        <div class="desct">
            <p>En esta sección se enlistarán las categorias existentes.</p>
        </div>
        <div class="con_info con_info_data">
            <div class="header_sectt">
                <a href="{{route('settings.category')}}" class="active">
                    Categorias
                </a>
                <a href="{{route('settings.category.des')}}">
                    ...
                    @foreach ($categories as $category)
                        <div class="category">
                            ...
                            <form action="{{ route('category.destroy') }}" method="post">
                                ...
                                <button type="submit" class="btn_trash">Eliminar</button>
                            </form>
