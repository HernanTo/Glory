...
<div class="container-index-user con-acount-general">
        <div class="header-table header__table__left">
            <div class="bread-cump">
                ...
                /
                <a href="{{ route('usuarios.usuario', $item->cc)}}">{{ $item->nameLast }}</a>
                /
                <a>Editar</a>
            </div>
        ...
        <div class="content-account content__edit">
            <div class="info-general-u">
                ...
                <div class="con-src-accounts">
                    <a href="{{route('usuarios.usuario', $item->cc)}}">Detalle</a>
                    <a href="{{route('usuarios.edit', $item->cc)}}" class="acco-active">Editar</a>
            ...
            <div class="main-sec-acco" id="sec__data">
                ...
                <div class="content-sec-ac">
                    {{-- @dd($item) --}}
                    <form action="{{route('usuarios.update', $item)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
            ...
            @if ($item->getRoleNames()->first() != 'Cliente')
                <div class="main-sec-acco" id="sec__rol">
                    ...
                    <div class="content-sec-ac content__sec__ac__rol">
                        <form action="{{route('usuarios.updateRole', $item)}}" method="post">
                            @csrf
                            @method('PUT')
